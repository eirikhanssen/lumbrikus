...
function lumbrikus_load_scripts() {
	...
	wp_enqueue_style( 'lumbrikus', get_template_directory_uri() . '/css/lumbrikus.css', array(), '119', 'all' );
	...
	wp_enqueue_script( 'lumbrikus', get_template_directory_uri() . '/js/lumbrikus.js', array('jquery'), '0.0.21', true );
	wp_enqueue_script( 'lightbox', '/lib/lightbox/js/lightbox.min.js', false, '2.10.0', true);
	

	if( is_page( 'kviss' ) ) {
		wp_enqueue_style( 'kviss', '/css/kviss.css', array(), '0.1.0', 'all' );
		wp_enqueue_script( 'kviss-js', '/js/kviss.js', array('jquery'), '0.9.2', true );
	}
	...
	if( is_page( 'kort' ) || is_page( 'lang' ) ) {
		...
		wp_enqueue_style( 'mediasyncCSS', '/css/mediasync.css', array(), '0.2.4', 'all' );
