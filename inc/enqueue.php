...
function lumbrikus_load_scripts() {
	...
	wp_enqueue_style( 'lumbrikusCSS', get_template_directory_uri() . '/css/lumbrikus.css', array(), '1.1.2', 'all' );
	...
	if( is_page( 'kort' ) || is_page( 'lang' ) ) {
		...
		wp_enqueue_style( 'mediasyncCSS', '/css/mediasync.css', array(), '0.1.0', 'all' );
