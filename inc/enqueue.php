...
function lumbrikus_load_scripts() {
	...
	wp_enqueue_style( 'lumbrikus', get_template_directory_uri() . '/css/lumbrikus.css', array(), '1.3.6', 'all' );
	wp_enqueue_style( 'lightbox', '/lib/lightbox/css/lightbox.css', array(), '2.10.0.1', 'all' );
