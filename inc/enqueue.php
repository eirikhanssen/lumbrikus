...
function lumbrikus_load_scripts() {
	...
	wp_enqueue_style( 'lightbox-css', '/lib/lightbox/css/lightbox.css', array(), '2.10.0', 'all' );
	...
	wp_enqueue_script( 'lightbox-js', '/lib/lightbox/js/lightbox.min.js', false, '2.10.0', true);
