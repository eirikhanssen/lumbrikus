...
function lumbrikus_load_scripts() {
	...
	wp_enqueue_style( 'lumbrikus', get_template_directory_uri() . '/css/lumbrikus.css', array(), '89', 'all' );
	...
	wp_enqueue_script( 'lumbrikus', get_template_directory_uri() . '/js/lumbrikus.js', array('jquery'), '0.0.14', true );
	...
	if( is_page( 'kviss' ) ) {
		...
		wp_enqueue_script( 'kviss-js', '/js/kviss.js', array('jquery'), '0.7.0', true );
	}
