...
function lumbrikus_load_scripts() {
	...
	wp_enqueue_style( 'lumbrikus', get_template_directory_uri() . '/css/lumbrikus.css', array(), '1.3.57', 'all' );
	...
	wp_enqueue_script( 'lumbrikus', get_template_directory_uri() . '/js/lumbrikus.js', array('jquery'), '0.0.10', true );
